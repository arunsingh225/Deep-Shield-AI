      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col gap-4">
          <div
            ...
            className={`border-2 border-dashed rounded-2xl p-8 flex flex-col items-center justify-center cursor-pointer transition-all min-h-[300px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500
